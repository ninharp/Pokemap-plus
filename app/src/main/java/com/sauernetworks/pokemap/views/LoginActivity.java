...
import com.sauernetworks.pokemap.controllers.net.GoogleManager;
import com.sauernetworks.pokemap.controllers.net.GoogleService;
import com.sauernetworks.pokemap.controllers.net.NianticManager;
...
public class LoginActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String text = getString(R.string.login_warning);
